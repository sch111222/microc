module ConsoleApplication7.SemanticAnalysis
...
type FunctionTable(program) as self =
    ...
    do
        ...
        self.Add("read",  { ReturnType = Int; ParameterTypes = []; })
        self.Add("print", { ReturnType = Void; ParameterTypes = [ { Type = Int; IsArray = false } ]; })
...
type SymbolTable(program) as self =
    ...
    let forStatementStack = Stack<ForStatement>()
    ...
    and scanFunctionDeclaration (functionReturnType, _, parameters, compoundStatement) =
        ...
        and scanStatement =
            ...
            |ForStatement(e,e1,s)->
                forStatementStack.Push(e,e1,s)
                scanExpression e
                scanStatement e1
                scanStatement s
                forStatementStack.Pop() |> ignore
            ...
            | BreakStatement ->
                ...
                if forStatementStack.Count = 0 then
                    raise (noEnclosingLoop())
